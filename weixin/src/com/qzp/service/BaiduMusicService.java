...
public class BaiduMusicService {
	  ...
	  private static Logger log = LoggerFactory.getLogger(BaiduMusicService.class); 
	    ...
	    public static void main(String[] args) {  
	        Music music = searchMusic("小苹果", "");  
	        //log.info("音乐名称：" + music.getTitle());
	        //log.info("音乐描述：" + music.getDescription());
	        //log.info("普通品质链接：" + music.getMusicUrl());
	        //log.info("高品质链接：" + music.getHQMusicUrl());
	    }  
}
